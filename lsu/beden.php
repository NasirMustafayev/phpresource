      ...
      <div class="content_middle">
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <center>
                    <div class="single_iteam">
                      ...
                      <div class="title_caption"><a href="egun.php?egun_id=<?php echo $egunal['egun_id'];?>"><h4 style="color: white"><?php echo $egunal['egun_ad'];?></h4></div></div>
                        <a style="float: right;color: teal" href="butun_egunler.php"><h4><u></u></h4></a>
                      </center>
                      <?php 
                    }
                    ?>
            ...
            <ul class="nav navbar-nav custom_nav-eres" style="margin-left: 12px">
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-list-alt"></i><br>Elektron Jurnal</a></li>
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-book"></i><br>Elektron Kitabxana</a></li>
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-language"></i><br>İngilis-dili mərkəzi</a></li>
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-globe"></i><br>Elektron Təhsil şəbəkəsi</a></li>
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-lightbulb-o"></i><br>Layihəni təqdim et</a></li>
              <li class="eres-cube"><a href="" style="font-size: 95%" class="wow fadeInLeft"><i style="font-size: 540%" class="fa fa-square"></i><br>Digər...</a></li>
            </ul>
          </div>
