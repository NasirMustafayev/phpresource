...
$(function(){
    ...
    $("body").removeClass("bordered").addClass("boxed");
    $(".compare-basket").addClass("boxed");

    if ($("body").hasClass("boxed")) {
        if($("#wrapper").is(":visible")) {

        }else {
            $("body > header, body > main, body > section, body > div , body > aside , body > footer").wrapAll('<div id="wrapper" class="main-wrapper boxed"></div>');
        }
    }
