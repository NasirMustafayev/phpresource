            ...
            <div class="container-fluid">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav custom_nav">
                  ...
                  <li class=""><a href="#" target="_blank" >Test</a></li>
                  ...
                  <li class="dropdown">
                    <a href="index.php" class="" data-toggle="dropdown" role="button" aria-expanded="false">KAFEDRALAR<i class="fa fa-arrow-circle-down"></i>
                    </a>
                    <ul class="dropdown-menu" role="menu">
