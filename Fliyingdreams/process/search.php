...
if (isset($_POST['query'])) {
	...
	$searchuser=$db->prepare("SELECT * FROM users where user_authorization=:authorization and user_name LIKE '$searchtext%' or user_lastname LIKE '$searchtext%' or user_mail LIKE '$searchtext%'");
