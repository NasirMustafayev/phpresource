 ...
 <footer>
 				...
 				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
 					<div class="footer-box">
 						...
 						<ul class="corporate-address">
 							<li><i class="fa fa-map-marker" aria-hidden="true"></i><a href="Phone(01)800433633"><?php echo $show['parametr_address']; ?></a></li>
 							<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo $show['parametr_gsm']; ?></li>
 							<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo $show['parametr_fax']; ?></li>
 							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><?php echo $show['parametr_mail']; ?></li>
 						</ul>
 					</div>
 				</div>
 				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
 	...
 	<div class="footer-area-bottom">
 		<div class="container">
 			<p>@ 2017 Foxtar market place. By <?php echo $show['parametr_author']; ?></p>
 		</div>
 	</div>
 </footer>
...
<!-- Email auto input -->
<script src="js/emailautoinput.js" ></script>
